...
[
    ...
    Output('modal-settings-bulk-isotopomer-heatmap', 'is_open'),
    ...
    Output('modal-p-value-isotopomer-distribution', 'is_open')
],
[
...
[
    ...
    State('modal-settings-bulk-isotopomer-heatmap', 'is_open'),
    ...
    State('modal-p-value-isotopomer-distribution', 'is_open')
],
)
